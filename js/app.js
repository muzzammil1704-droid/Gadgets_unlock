const app = {
            ...
            // ========== ADMIN PANEL ==========
            // Password is never stored in plain text - only its SHA-256 hash is kept here.
            adminPasswordHash: '1c1b72aee1bf62759f34d254e0fb8ce2dafb480d42bc5ab1f5af0bdb6e53d108',
            editingIndex: -1,
            ...
            async adminLogin() {
                ...
                const enteredHash = await this.sha256(pass);
                if (enteredHash === this.adminPasswordHash) {
