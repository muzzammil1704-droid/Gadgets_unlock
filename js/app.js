const app = {
                    ...
                    <div class="product-card group" onclick="app.showProductDetail(${idx})">
                        ...
                        <div class="p-5">
                            <div class="flex items-center gap-2 mb-2 flex-wrap">
                                ...
                                ${product.cod !== false ? '<span class="text-xs font-medium text-green-700 bg-green-50 px-2 py-1 rounded-full">💵 COD</span>' : ''}
            ...
            showAddProductForm() {
                ...
                document.getElementById('f-cod').checked = true;
            ...
            editProduct(index) {
                ...
                document.getElementById('f-cod').checked = p.cod !== false;
            ...
            async saveProduct() {
                ...
                try {
                    ...
                    const cod = document.getElementById('f-cod').checked;
                    const codCharge = parseInt(document.getElementById('f-cod-charge').value) || 0;
