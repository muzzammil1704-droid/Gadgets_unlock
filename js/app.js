const app = {
            ...
            async deleteProduct(index) {
                ...
                if (p.id && typeof db !== 'undefined') {
                    ...
                    // This product only exists in the original JSON file, not in the cloud yet.
                    // A local-only delete would come back on next visit/reload.
                    alert('Idhu innum Cloud la illa!\n\n"Import existing products to Cloud" button ah முதலில் click pannunga (oru murai mattum). Adhுக்கு அப்புறம் delete pannினா everyone ku permanent ah maarum.');
                    return;
                }
            },
