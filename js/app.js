const app = {
            ...
            jsonFiles: {
                ...
                analogwatch: 'analogwatches.json',
            ...
            categoryMap: { smartwatch: 'Smart Watch', automaticwatch: 'Automatic Watch', analogwatch: 'Analog Watch', powerbank: 'Powerbank', neckband: 'Neckband', headphone: 'Headphones', earbuds: 'Earbuds', speaker: 'Speakers' },
            ...
            showModal(type) {
                ...
                if (type === 'search') {
                    ...
                    <nav class="space-y-1 max-h-[70vh] overflow-y-auto pb-4">
                        ...
                        <a href="#" onclick="app.closeModal(); app.filterCategory('analogwatch')" class="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors"><span class="w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center"><i class="fas fa-clock text-indigo-600"></i></span> Analog Watches</a>
            ...
            filterCategory(cat) {
                ...
                const map = { all: 'btn-all', smartwatch: 'btn-smartwatch', automaticwatch: 'btn-automaticwatch', analogwatch: 'btn-analogwatch', powerbank: 'btn-powerbank', neckband: 'btn-neckband', headphone: 'btn-headphone', earbuds: 'btn-earbuds', speaker: 'btn-speaker' };
            ...
            renderAdminList() {
                ...
                list.innerHTML = this.allProducts.map((p, i) => `
